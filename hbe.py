...
#start -> next (//*[@id="instPaginationa"]) -> t&c(//*[@id="disclaimer"]) -> startTest(//*[@id="secondPagep2"]/div/input)
def attempt():
    anskey=[]
    ...
    time.sleep(1)
    # driver.find_element_by_xpath('//*[@id="radio-choice-0a"]').click()
...
#//*[@id="C_1"]
#//*[@id="D_1"]
##-> next->(//*[@id="foot"]/div[1]/div[3]/a)
#and cycle continues


#after done 3lines right
#//*[@id="demo-page"]/div[1]/a[2]
#submit test
#//*[@id="activator"]/a
#finished test chkbox
#//*[@id="radio-choice-0a"]
#submitfinal
#//*[@id="close_confirmed"]
